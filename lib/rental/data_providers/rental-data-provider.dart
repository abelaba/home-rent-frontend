...
class RentalDataProvider {
  ...
  String token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MTM1MzlkMWIwMmEyMzRlNDQxNjkzYzUiLCJpYXQiOjE2MzA4NzgxNzd9.8zNkPTvrJ4VKdQqYQca-P41QZubZRdit04S9Kzoksco";
  ...
  Future<void> delete(String id) async {
    ...
    final response = await http
        .delete(Uri.parse("$_baseUrl/delete/$id"), headers: <String, String>{
      "Content-Type": "application/json",
      "auth-token":
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MTIyMDJhODVkYzQyOTMxOWM2MDZmNWEiLCJpYXQiOjE2Mjk2Mzc0NzZ9.wzSZOAp1WdEV7F0SRPe3a8o5T97QkOdy8L-cbNbFtsM"
    });
